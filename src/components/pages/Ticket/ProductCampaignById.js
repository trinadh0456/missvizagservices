        ...
        if (user) {
            if (counter > 0) {
                ...
                async function displayRazorpay() {
                    ...
                    const tamount = 650 * parseInt(counter)
        ...
        <div>
            ...
            <div className="LPRL_Des" style={{ background: "black", color: "white" }}>
                <Container >
                    ...
                    <Typography style={{ background: "black", color: "white" }}><br />
                        <span style={{ color: 'orange' }}>Cancellation and Refund policy </span><br />
                        The payments made for booking ticket on the platform is non-refundable at any time as it is not a recurring payment for which all the default features are enabled which incurs the cost to the company.<br /><br />
                        <span >  This Website is created and operated by Vizag Celebrities  has  represented by its Directors, hereinafter referred to as the “Company”(where such expression shall, unless repugnant to the context thereof, be deemed to include its representatives, administrators, permitted assigns).
                            ...
                            Data we collect from users who are not registered as  behavior, pages viewed, etc. We also collect and store . We only collect and use such information from you that we consider necessary for achieving a seamless, efficient, and safe experience, customized to your needs including:</span><br />
                        <ul>
                            <li> To enable the provision of services opted for by you.
                                To enable the viewing of content in your interest</li>
                            ...
                            <li>If the event is postponed your money is safe is with us and and your money can't be refunded</li>
